...
REGIONS = []
REGIONS.append(irispy.inflate_region(obstacles, np.array([3,0,0]), bounds)) # in front
REGIONS.append(irispy.inflate_region(obstacles, np.array([-3,0,0]), bounds)) # in back
REGIONS.append(irispy.inflate_region(obstacles, np.array([0,0,0]), bounds)) # in between
